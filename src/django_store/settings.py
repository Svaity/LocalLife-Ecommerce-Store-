...
SECRET_KEY = '-ox0zq^pt_$1d8tk@==f+wawvmx5&z%kr40s2-kb4*4p9++l&4'
...
<<<<<<< HEAD
=======
<<<<<<< HEAD:src/localLife/settings.py
    'products',
    'pages',
    'register',
=======
>>>>>>> cb63af76e6e079dfe5bbd22bbc8f57199ccf9375:IT1/django_store/settings.py
